                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-8">
                                {colorSchema.options.map((c) =>
                                    <div className={clsx(`h-9 flex justify-center items-center rounded-xl  border-gray-900 ${bgColorClasses[300][c]}`, c === color && "border")} onClick={() => setColor((prev) => prev === c ? null : c)}>{c === color && <Check />} </div>
                                )}
                            </div>
