    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-6">
                {/* Account card */}
                <Card className={`rounded-2xl text-white shadow-lg border-0 bg-linear-to-br  ${fromColorClasses[800][account.color]}
            ...
            ${textColorClasses[50][account.color]} `}>
                    <CardContent className=" flex flex-col justify-between">
                        ...
                        <div>
                            <p className="text-xs opacity-75 mb-1">{toStringTypeAccount(account)
                            }</p>
                ...
                {/* Actions */}
                <Button onClick={() => router.push(`/accounts/${account.IBAN}/transactions/new`)} className="flex-1 mx-1 bg-gray-100 text-gray-800 hover:bg-gray-200">Transférer</Button>
                <Separator />
                {/* Transactions */}
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-3">
                        {transactions.map((t) => (
                            <Link href={`/accounts/${account.IBAN.toLowerCase()}/transactions/${t.id}`} key={t.id} className="flex justify-between items-center rounded-lg p-2 hover:bg-gray-50">
                                ...
                                <div className={clsx("font-semibold", t.amount < 0 ? "text-red-500" : "text-green-500")}>
