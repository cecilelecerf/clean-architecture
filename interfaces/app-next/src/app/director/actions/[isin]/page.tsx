...
export default function ActionDetailsPage() {
    ...
    const priceHistoryQuery = useQuery(endpoints.actions.getHistory({ isin }));
    ...
    return (
        <div className="space-y-4 pb-20 md:pb-8">
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white border-t md:hidden">
                <Button
                    onClick={() => router.push(`/admin/actions/${isin}/edit`)}
                    className="w-full bg-linear-to-r from-blue-600 to-indigo-700"
                    size="lg"
                >
            ...
            <div className="hidden md:block fixed bottom-8 right-8">
                <Button
                    onClick={() => router.push(`/admin/actions/${isin}/edit`)}
                    className="bg-linear-to-r from-blue-600 to-indigo-700 shadow-lg"
                    size="lg"
                >
                    <Edit className="w-4 h-4 mr-2" />
                    Modifier
