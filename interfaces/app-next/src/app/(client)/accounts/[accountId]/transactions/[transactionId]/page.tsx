...
export default function TransactionIdPage() { return <></> }
...
//               {mockAccounts.findLast((account) => account.IBAN === transaction.fromAccountId)
//                 .name ?? 'e'}
//             </p>
//           </div>
//           <div className="flex justify-between text-lg">
...
//             <p className="truncate">
//               {mockAccounts.findLast((account) => account.IBAN === transaction.toAccountId).name ??
//                 'e'}
//             </p>
//           </div>
//         </CardContent>
