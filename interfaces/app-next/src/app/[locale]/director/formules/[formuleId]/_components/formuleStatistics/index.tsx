...
export const FormuleStatistics = memo(({ formuleId }: FormuleStatisticsProps) => {
    ...
    const detailStats = useMemo(() => {
        if (query.status !== "success") return [];
        const total = query.data.totalCreditsCount;
        return [
            {
                icon: CheckCircle,
...
FormuleStatistics.displayName = 'FormuleStatistics';